// Edge Function for sending invitation emails via Resend (INLINE HTML - PROVEN TO WORK)
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Send the email via Resend with inline HTML (NOT template - templates don't work!)
